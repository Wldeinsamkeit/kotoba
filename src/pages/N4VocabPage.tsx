...
export function N4VocabPage() {
  ...
  const filtered = useMemo(() => n4MoatVocab.filter((e) => {
  ...
  return (
    <div className="page word-moat-page">
      ...
      <div className="word-moat-body">
        ...
        {tab === 'stats' && <StatsPanel srs={srs} allIds={filteredIds} vocabMap={Object.fromEntries(n4MoatVocab.map((e) => [e.id, e]))} />}
        </div>
      </div>
    </div>
  )
